...
namespace Inworld.Framework.Graph
{
    ...
    /// </summary>
    [CreateAssetMenu(fileName = "New Safety Edge", menuName = "Inworld/Create Edge/Safety", order = -2699)]
    public class InworldSafetyEdgeAsset : InworldEdgeAsset
    {
        public override string EdgeTypeName => "SafetyEdge";
        ...
        {
            SafetyResult safetyResult = new SafetyResult(inputData);
            if (!safetyResult.IsValid)
                return false;
            return m_AllowedPassByDefault ? safetyResult.IsSafe : !safetyResult.IsSafe;
        }
    }
}