...
namespace Inworld.Framework.Samples.Node
{
    ...
    /// </summary>
    public class SafetyNodeTemplate : NodeTemplate
    {
        ...
        void DisplaySafety(SafetyResult result)
        {
            string strMessage = $"{result.Content}. Safe: {result.IsSafe}";
            InsertBubble(m_BubbleRight, "SafetyChecker", strMessage);
        }
