...
{
    public class InworldCreationContext : InworldContext, IGetNodeHandler
    {
        public InworldCreationContext(ComponentStore componentStore)
        {
            m_DLLPtr = MemoryManager.Register(InworldInterop.inworld_CreationContext_new(componentStore.ToDLL), InworldInterop.inworld_CreationContext_delete);
        }
        public InworldCreationContext(IntPtr rhs)
        {
            m_DLLPtr = MemoryManager.Register(rhs, InworldInterop.inworld_CreationContext_delete);
        }
        
        public GoalAdvancementNode GetGoalAdvancementNode(string componentID)
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_GoalAdvancementNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_IntentNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_KeywordMatcherNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_KnowledgeNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_LLMChatNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_LLMChatRequestBuilderNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_LLMCompletionNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_LLMPromptBuilderNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_MemoryUpdateNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_MemoryRetrieveNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_RandomCannedTextNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_SafetyCheckerNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_STTNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_TextAggregatorNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_TextChunkingNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_TTSNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_MCPListToolsNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_LLMInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_STTInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_TTSInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_TextEmbedderInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_KnowledgeInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_CreationContext_GetComponent_MCPClientInterface(m_DLLPtr, componentID),
