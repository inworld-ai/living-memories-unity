...
{
    public class ProcessContext : InworldContext, IGetNodeHandler
    {
        public ProcessContext(ProcessContext rhs)
        {
            m_DLLPtr = MemoryManager.Register(InworldInterop.inworld_ProcessContext_copy(rhs.ToDLL), InworldInterop.inworld_ProcessContext_delete);
        }
        public ProcessContext(IntPtr rhs)
        {
            m_DLLPtr = MemoryManager.Register(rhs, InworldInterop.inworld_ProcessContext_delete);
        }
        
        public string Variant => InworldInterop.inworld_ProcessContext_GetVariant(m_DLLPtr);

        public string ExecutionID => InworldInterop.inworld_ProcessContext_GetExecutionId(m_DLLPtr);
        
        public NodeExecutionConfig Config  => new NodeExecutionConfig(InworldInterop.inworld_ProcessContext_GetConfig(m_DLLPtr));
        
        public bool IsCancelled => InworldInterop.inworld_ProcessContext_IsCancelled(m_DLLPtr);
        
        public CancellationContext CancellationContext => new CancellationContext(InworldInterop.inworld_ProcessContext_GetCancellationContext(m_DLLPtr));
        
        public NodeExecutionTelemetryContext NodeExecutionTelemetryContext => new NodeExecutionTelemetryContext(InworldInterop.inworld_ProcessContext_GetNodeExecutionTelemetryContext(m_DLLPtr));
        
        public GoalAdvancementNode GetGoalAdvancementNode(string componentID)
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_GoalAdvancementNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_IntentNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_KeywordMatcherNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_KnowledgeNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_LLMChatNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_LLMChatRequestBuilderNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_LLMCompletionNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_LLMPromptBuilderNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_MemoryUpdateNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_MemoryRetrieveNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_RandomCannedTextNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_SafetyCheckerNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_STTNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_TextAggregatorNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_TextChunkingNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_TTSNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_MCPListToolsNode(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_LLMInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_STTInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_TTSInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_TextEmbedderInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_KnowledgeInterface(m_DLLPtr, componentID),
        ...
        {
            IntPtr result = InworldFrameworkUtil.Execute(
                InworldInterop.inworld_ProcessContext_GetComponent_MCPClientInterface(m_DLLPtr, componentID),
